module params
  ...
  real :: pad_finest
  real, dimension(3) :: x0, ex, xc, shift
  
  integer :: levelmin, levelmax, nlevel, npad
  ! integer :: ix, iy, iz
  ! integer :: nx, ny, nz

  real :: omega_m, omega_v, boxlen, H0, astart, xi, yi, zi
...
program ref_mask
  ...
  real :: lx, ly, lz, rx, ry, rz
  
  real, external :: func_dtdacube, rombint

  namelist /mask_params/ levelmin, levelmax, xi, yi, zi, A11, A12, A13, &
       A21, A22, A23, A31, A32, A33, lx, rx, ly, ry, lz, rz, npad, path
